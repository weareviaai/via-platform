...
This event will be generated whenever a new conversation profile is created. The conversation profile contains an AI-generated summary (typically using a reasoning model) of the conversation where the prompt is defined at the tenant level (i.e. is identical for all tenant projects) by a VIA admin.
